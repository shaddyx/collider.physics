class SquareMesh2D extends lib.physics.Mesh2D{
    constructor(from, to, center){
       //super({center: center, from: from, to: to});
       this.size = size || new lib.physics.Vector2D();
       /** @type {Vector2D} */
       this.from = from || new lib.physics.Vector2D();
       /** @type {Vector2D} */
       this.to = to || new lib.physics.Vector2D();
    }
    moveTo(vector){
